...
struct ImVec2
{
    ...
    float& operator[] (size_t idx)          { (void)( (!!(idx == 0 || idx == 1)) || (_wassert(L"idx == 0 || idx == 1", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(297)), 0) ); return ((float*)(void*)(char*)this)[idx]; } 
    float  operator[] (size_t idx) const    { (void)( (!!(idx == 0 || idx == 1)) || (_wassert(L"idx == 0 || idx == 1", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(298)), 0) ); return ((const float*)(const void*)(const char*)this)[idx]; }
};
struct ImVec4
{
    float                                                     x, y, z, w;
...
struct ImVector
{
    ...
    inline T&           operator[](int i)                   { (void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2157)), 0) ); return Data[i]; }
    inline const T&     operator[](int i) const             { (void)( (!!(i >= 0 && i < Size)) || (_wassert(L"i >= 0 && i < Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2158)), 0) ); return Data[i]; }
    inline T*           begin()                             { return Data; }
    inline const T*     begin() const                       { return Data; }
    inline T*           end()                               { return Data + Size; }
    inline const T*     end() const                         { return Data + Size; }
    inline T&           front()                             { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2164)), 0) ); return Data[0]; }
    inline const T&     front() const                       { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2165)), 0) ); return Data[0]; }
    inline T&           back()                              { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2166)), 0) ); return Data[Size - 1]; }
    inline const T&     back() const                        { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2167)), 0) ); return Data[Size - 1]; }
    inline void         swap(ImVector<T>& rhs)              { int rhs_size = rhs.Size; rhs.Size = Size; Size = rhs_size; int rhs_cap = rhs.Capacity; rhs.Capacity = Capacity; Capacity = rhs_cap; T* rhs_data = rhs.Data; rhs.Data = Data; Data = rhs_data; }
    inline int          _grow_capacity(int sz) const        { int new_capacity = Capacity ? (Capacity + Capacity / 2) : 8; return new_capacity > sz ? new_capacity : sz; }
    inline void         resize(int new_size)                { if (new_size > Capacity) reserve(_grow_capacity(new_size)); Size = new_size; }
    inline void         resize(int new_size, const T& v)    { if (new_size > Capacity) reserve(_grow_capacity(new_size)); if (new_size > Size) for (int n = Size; n < new_size; n++) memcpy(&Data[n], &v, sizeof(v)); Size = new_size; }
    inline void         shrink(int new_size)                { (void)( (!!(new_size <= Size)) || (_wassert(L"new_size <= Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2173)), 0) ); Size = new_size; } 
    ...
    inline void         pop_back()                          { (void)( (!!(Size > 0)) || (_wassert(L"Size > 0", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2179)), 0) ); Size--; }
    inline void         push_front(const T& v)              { if (Size == 0) push_back(v); else insert(Data, v); }
    inline T*           erase(const T* it)                  { (void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2181)), 0) ); const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + 1, ((size_t)Size - (size_t)off - 1) * sizeof(T)); Size--; return Data + off; }
    inline T*           erase(const T* it, const T* it_last){ (void)( (!!(it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size)) || (_wassert(L"it >= Data && it < Data + Size && it_last >= it && it_last <= Data + Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2182)), 0) ); const ptrdiff_t count = it_last - it; const ptrdiff_t off = it - Data; memmove(Data + off, Data + off + count, ((size_t)Size - (size_t)off - (size_t)count) * sizeof(T)); Size -= (int)count; return Data + off; }
    inline T*           erase_unsorted(const T* it)         { (void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2183)), 0) );  const ptrdiff_t off = it - Data; if (it < Data + Size - 1) memcpy(Data + off, Data + Size - 1, sizeof(T)); Size--; return Data + off; }
    inline T*           insert(const T* it, const T& v)     { (void)( (!!(it >= Data && it <= Data + Size)) || (_wassert(L"it >= Data && it <= Data + Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2184)), 0) ); const ptrdiff_t off = it - Data; if (Size == Capacity) reserve(_grow_capacity(Size + 1)); if (off < (int)Size) memmove(Data + off + 1, Data + off, ((size_t)Size - (size_t)off) * sizeof(T)); memcpy(&Data[off], &v, sizeof(v)); Size++; return Data + off; }
    ...
    inline int          index_from_ptr(const T* it) const   { (void)( (!!(it >= Data && it < Data + Size)) || (_wassert(L"it >= Data && it < Data + Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2191)), 0) ); const ptrdiff_t off = it - Data; return (int)off; }
};
struct ImGuiStyle
{
    float       Alpha;                      
...
struct ImGuiTextBuffer
{
    ...
    ImGuiTextBuffer()   { }
    inline char         operator[](int i) const { (void)( (!!(Buf.Data != ((void *)0))) || (_wassert(L"Buf.Data != ((void *)0)", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(2657)), 0) ); return Buf.Data[i]; }
...
struct ImFontAtlas
{
    ...
    ImFontAtlasCustomRect*      GetCustomRectByIndex(int index) { (void)( (!!(index >= 0)) || (_wassert(L"index >= 0", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(3455)), 0) ); return &CustomRects[index]; }
...
struct ImGuiViewport
{
    ...
    ~ImGuiViewport()    { (void)( (!!(PlatformUserData == ((void *)0) && RendererUserData == ((void *)0))) || (_wassert(L"PlatformUserData == ((void *)0) && RendererUserData == ((void *)0)", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui.h", (unsigned)(3615)), 0) ); }
...
struct ImBitArray
{
    ...
    bool            TestBit(int n) const        { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(616)), 0) ); return ((Storage[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
    void            SetBit(int n)               { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(617)), 0) ); ImBitArraySetBit(Storage, n); }
    void            ClearBit(int n)             { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(618)), 0) ); ImBitArrayClearBit(Storage, n); }
    void            SetBitRange(int n, int n2)  { n += OFFSET; n2 += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT && n2 > n && n2 <= BITCOUNT", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(619)), 0) ); ImBitArraySetBitRange(Storage, n, n2); } 
    bool            operator[](int n) const     { n += OFFSET; (void)( (!!(n >= 0 && n < BITCOUNT)) || (_wassert(L"n >= 0 && n < BITCOUNT", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(620)), 0) ); return ((Storage[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
};
struct  ImBitVector
{
    ...
    bool            TestBit(int n) const        { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(630)), 0) ); return ((Storage.Data[(n) >> 5] & ((ImU32)1 << ((n) & 31))) != 0); }
    void            SetBit(int n)               { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(631)), 0) ); ImBitArraySetBit(Storage.Data, n); }
    void            ClearBit(int n)             { (void)( (!!(n < (Storage.Size << 5))) || (_wassert(L"n < (Storage.Size << 5)", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(632)), 0) ); ImBitArrayClearBit(Storage.Data, n); }
};
template<typename T>
struct ImSpan
{
    ...
    inline T&           operator[](int i)           { T* p = Data + i; (void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(653)), 0) ); return *p; }
    inline const T&     operator[](int i) const     { const T* p = Data + i; (void)( (!!(p >= Data && p < DataEnd)) || (_wassert(L"p >= Data && p < DataEnd", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(654)), 0) ); return *p; }
    inline T*           begin()                     { return Data; }
    inline const T*     begin() const               { return Data; }
    inline T*           end()                       { return DataEnd; }
    inline const T*     end() const                 { return DataEnd; }
    inline int  index_from_ptr(const T* it) const   { (void)( (!!(it >= Data && it < DataEnd)) || (_wassert(L"it >= Data && it < DataEnd", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(662)), 0) ); const ptrdiff_t off = it - Data; return (int)off; }
};
template<int CHUNKS>
struct ImSpanAllocator
{
    ...
    inline void  Reserve(int n, size_t sz, int a=4) { (void)( (!!(n == CurrIdx && n < CHUNKS)) || (_wassert(L"n == CurrIdx && n < CHUNKS", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(678)), 0) ); CurrOff = (((CurrOff) + ((a) - 1)) & ~((a) - 1)); Offsets[n] = CurrOff; Sizes[n] = (int)sz; CurrIdx++; CurrOff += (int)sz; }
    inline int   GetArenaSizeInBytes()              { return CurrOff; }
    inline void  SetArenaBasePtr(void* base_ptr)    { BasePtr = (char*)base_ptr; }
    inline void* GetSpanPtrBegin(int n)             { (void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(681)), 0) ); return (void*)(BasePtr + Offsets[n]); }
    inline void* GetSpanPtrEnd(int n)               { (void)( (!!(n >= 0 && n < CHUNKS && CurrIdx == CHUNKS)) || (_wassert(L"n >= 0 && n < CHUNKS && CurrIdx == CHUNKS", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(682)), 0) ); return (void*)(BasePtr + Offsets[n] + Sizes[n]); }
    template<typename T>
...
struct ImPool
{
    ...
    ImPoolIdx   GetIndex(const T* p) const          { (void)( (!!(p >= Buf.Data && p < Buf.Data + Buf.Size)) || (_wassert(L"p >= Buf.Data && p < Buf.Data + Buf.Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(703)), 0) ); return (ImPoolIdx)(p - Buf.Data); }
...
struct ImChunkStream
{
    ...
    T*      next_chunk(T* p)            { size_t HDR_SZ = 4; (void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(735)), 0) ); p = (T*)(void*)((char*)(void*)p + chunk_size(p)); if (p == (T*)(void*)((char*)end() + HDR_SZ)) return (T*)0; (void)( (!!(p < end())) || (_wassert(L"p < end()", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(735)), 0) ); return p; }
    int     chunk_size(const T* p)      { return ((const int*)p)[-1]; }
    T*      end()                       { return (T*)(void*)(Buf.Data + Buf.Size); }
    int     offset_from_ptr(const T* p) { (void)( (!!(p >= begin() && p < end())) || (_wassert(L"p >= begin() && p < end()", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(738)), 0) ); const ptrdiff_t off = (const char*)p - Buf.Data; return (int)off; }
    T*      ptr_from_offset(int off)    { (void)( (!!(off >= 4 && off < Buf.Size)) || (_wassert(L"off >= 4 && off < Buf.Size", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(739)), 0) ); return (T*)(void*)(Buf.Data + off); }
...
struct  ImGuiInputTextState
{
    ...
    void        ReloadUserBufAndSelectAll()     { ReloadUserBuf = true; ReloadSelectionStart = 0; ReloadSelectionEnd = 2147483647; }
    ...
    void        ReloadUserBufAndMoveToEnd()     { ReloadUserBuf = true; ReloadSelectionStart = ReloadSelectionEnd = 2147483647; }
};
...
struct ImGuiNavItemData
{
    ...
    void Clear()        { Window = ((void *)0); ID = FocusScopeId = 0; InFlags = 0; SelectionUserData = -1; DistBox = DistCenter = DistAxial = 3.402823466e+38F; }
};
...
struct ImGuiContext
{
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas)
    {
        ...
        HoveredWindowBeforeClear = ((void *)0);
        MovingWindow = ((void *)0);
...
namespace ImGui
{
    ...
    inline ImGuiKey         MouseButtonToKey(ImGuiMouseButton button)                   { (void)( (!!(button >= 0 && button < ImGuiMouseButton_COUNT)) || (_wassert(L"button >= 0 && button < ImGuiMouseButton_COUNT", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(3567)), 0) ); return (ImGuiKey)(ImGuiKey_MouseLeft + button); }
    ...
    inline ImGuiKeyOwnerData* GetKeyOwnerData(ImGuiContext* ctx, ImGuiKey key)          { if (key & ImGuiMod_Mask_) key = ConvertSingleModFlagToKey(key); (void)( (!!(IsNamedKey(key))) || (_wassert(L"IsNamedKey(key)", L"C:\\Code\\cimgui-sokol-starterkit\\cimgui\\generator\\../imgui/imgui_internal.h", (unsigned)(3593)), 0) ); return &ctx->KeysOwnerData[key - ImGuiKey_NamedKey_BEGIN]; }
